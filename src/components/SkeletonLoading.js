    ...
    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {Array.from(new Array(4)).map((_, index) => (
        ...
        >
          ...
          <Skeleton variant="text" height={32} width="80%" className="mt-4" />
          <Skeleton variant="text" height={24} width="90%" className="mt-2" />
          <Skeleton variant="text" height={24} width="60%" className="mt-2" />
          <Skeleton variant="text" height={24} width="50%" className="mt-2" />
          <Skeleton
            variant="rectangular"
            width="100%"
            height={40}
