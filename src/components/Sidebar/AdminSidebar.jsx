...
export default function Sidebar() {
  ...
  return (
    <div
      className={`h-full bg-wcolor dark:bg-darkBackground border-box rounded-2xl border-1 dark:border-darkBorder light:bg-white drop-shadow-lg p-4 transition-all duration-200 ${
