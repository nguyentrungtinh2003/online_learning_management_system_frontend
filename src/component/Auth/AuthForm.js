...
export default function AuthForm() {
  ...
  useEffect(() => {
    ...
    // Sau khi animation kết thúc, loại bỏ class
    setTimeout(() => {
    ...
    <div className='login-container'>
        <div className='form-container' ref={formContainerRef}>
            <div className='form-toggle'>
                ...
                setIsLogin(true)}>Sign In</button>
                <button className={!isLogin ? 'active' : ""} onClick={() =>
                setIsLogin(false)}>Sign Up</button>
            </div>
            {isLogin ? <>
            <div className='login-form'>
                ...
                <p>You don't have an account?<a href='#' onClick={() =>
                     setIsLogin(false)}> Sign Up Now</a></p>
            </div>
            </> : <>
