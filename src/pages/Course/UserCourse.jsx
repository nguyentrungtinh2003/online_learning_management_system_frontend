    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <p className="text-xl lg:text-xs dark:text-darkSubtext mb-2">
          ...
          <span className="text-fcolor">{/* Format date if needed */}</span>
        </p>
        <div
          ...
          {completedCourses.length === 0 && inProgressCourses.length === 0 ? (
            <div className="flex h-full flex-col items-center justify-center text-center py-10 px-4">
              ...
              <button
                ...
                className="mt-2 inline-flex items-center px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-600 text-white font-medium transition"
              >
                {t("exploreCourses")}
              </button>
            </div>
