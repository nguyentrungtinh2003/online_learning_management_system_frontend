...
const RankChangeIcon = ({ rankEnum }) => {
  ...
  if (rankEnum === "DOWN")
    return (
      <ArrowDown className="text-red-500 w-5 h-5 animate-bounce animation-reverse" />
    );
    ...
    <div className="w-full px-4 py-10">
      ...
      <div className="flex flex-wrap justify-center items-end gap-6 mb-12">
        {[1, 0, 2].map((rank) => {
          ...
          const size =
            rank === 0
              ? "lg:w-24 lg:h-24 w-64 h-64"
              : "lg:w-20 lg:h-20 h-48 w-48";
          return (
            <div
              key={rank}
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    <span
                      className={`text-3xl lg:text-xl font-bold w-6 text-center ${rankColor}`}
                    >
                      {index + 1}
                    </span>
