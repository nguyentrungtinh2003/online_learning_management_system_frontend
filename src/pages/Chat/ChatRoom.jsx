          ...
          {loadingChatRoom ? (
            ...
            <>
                      ...
                      {msg.user1Id === user1Id && !msg.isDeleted && (
                        <div className="absolute top-10 -left-10 -translate-y-full">
                          <div className="relative">
                            ...
                            <div className="hidden group-hover:block absolute -top-2 right-6 mt-1 w-20 bg-wcolor border-2 dark:border-darkBorder rounded shadow-md z-10">
                              <button
              ...
              <div className="flex mt-4 items-center space-x-2">
                ...
                <button onClick={addChat} disabled={isSending}>
