...
export default function UserQuizz() {
  ...
  return (
    <div className="h-screen flex flex-1 py-3 text-sm font-semibold box-border relative">
      ...
      <div className="shadow h-full p-4 space-y-4 mx-2 justify-between flex flex-col rounded-xl w-[250px]">
        ...
        <p className="flex-end w-fit text-sm">1. Khái niệm kỹ thuật cần biết</p>
      </div>
    </div>
  );
}
